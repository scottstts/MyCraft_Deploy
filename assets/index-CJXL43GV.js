const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Engine-DIV6Api3.js","assets/three-diuLMvqP.js","assets/three-examples-B33R7ZzJ.js","assets/react-BTd0cbev.js","assets/vendor-DsoqlaW1.js"])))=>i.map(i=>d[i]);
import{r as C,j as n,R as W,c as Bt}from"./react-BTd0cbev.js";import{c as xt,a as Y}from"./vendor-DsoqlaW1.js";import{D as bt,l as wt,m as Ut,n as vt,o as Xt,p as yt,V as X,M as Gt,q as Zt,P as qt,r as Yt,s as Kt,t as Jt,i as N,u as Q}from"./three-diuLMvqP.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();const Qt="modulepreload",er=function(e){return"/"+e},Ze={},tr=function(t,r,a){let o=Promise.resolve();if(r&&r.length>0){let p=function(h){return Promise.all(h.map(d=>Promise.resolve(d).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");o=p(r.map(h=>{if(h=er(h),h in Ze)return;Ze[h]=!0;const d=h.endsWith(".css"),x=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${x}`))return;const w=document.createElement("link");if(w.rel=d?"stylesheet":Qt,d||(w.as="script"),w.crossOrigin="",w.href=h,l&&w.setAttribute("nonce",l),document.head.appendChild(w),d)return new Promise((A,y)=>{w.addEventListener("load",A),w.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${h}`)))})}))}function i(s){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=s,window.dispatchEvent(l),!l.defaultPrevented)throw s}return o.then(s=>{for(const l of s||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},H=[{id:"tiny",label:"tiny",side:3,chunkCount:9},{id:"small",label:"small",side:5,chunkCount:25},{id:"medium",label:"medium",side:7,chunkCount:49},{id:"large",label:"large",side:9,chunkCount:81},{id:"extra-large",label:"extra large",side:11,chunkCount:121},{id:"full-world",label:"full world",side:13,chunkCount:169}],St=H[0];St.id;const Et=St.chunkCount;function He(e){return H.find(t=>t.chunkCount===e)}function Oe(e){return He(e)?.chunkCount??Et}const ve=["Otherys","Solvaris","Eryndor","Vespera","Kaelith"],Ve="Otherys",rr=[{id:"Otherys",name:"Otherys",accent:"#22d3ee"},{id:"Solvaris",name:"Solvaris",accent:"#f59e0b"},{id:"Eryndor",name:"Eryndor",accent:"#b86cff"},{id:"Vespera",name:"Vespera",accent:"#f472b6"},{id:"Kaelith",name:"Kaelith",accent:"#38bdf8"}];function Rt(e){return typeof e=="string"&&ve.includes(e)?e:Ve}function Ta(e){const t=Rt(e),r=ve.indexOf(t);return ve[(r+1)%ve.length]??Ve}const ar=[1,2,3,4,5,6,7,8,9],f=xt(e=>({selectedSlot:0,setSelectedSlot:t=>e({selectedSlot:Math.max(0,Math.min(8,Math.floor(t)))}),hotbar:ar.slice(),setHotbar:t=>e({hotbar:t.slice(0,9)}),fps:0,setFps:t=>e({fps:t}),paused:!1,setPaused:t=>e({paused:t}),inGame:!1,setInGame:t=>e({inGame:t}),debugVisible:!1,setDebugVisible:t=>e({debugVisible:t}),audioVisible:!1,setAudioVisible:t=>e({audioVisible:t}),playerCharacter:Ve,setPlayerCharacter:t=>e({playerCharacter:Rt(t)}),restartToken:0,bumpRestartToken:()=>e(t=>({restartToken:t.restartToken+1})),gameStarted:!1,setGameStarted:t=>e({gameStarted:t}),chunkCount:Et,setChunkCount:t=>e({chunkCount:Oe(t)}),loading:!1,setLoading:t=>e({loading:t}),startupStage:null,setStartupStage:t=>e({startupStage:t}),startupError:null,setStartupError:t=>e({startupError:t})})),nr=["Away.mp3","By the Sea.mp3","Evening Glow.mp3","Golden Hour.mp3","Ocean Breeze.mp3","Sand Castle.mp3","Serenade.mp3","Silhouette.mp3","Static_Dream.mp3","Wind Whisper.mp3"],or=nr.map(e=>{const r=(e.replace(/\.[^.]+$/,"")||"Track").replace(/[_-]+/g," ").replace(/\s+/g," ");return{url:`/music/${encodeURIComponent(e)}`,name:r}});let P=null,M=[],G=0,ne=!1;function ir(e){const t=e.slice();for(let r=t.length-1;r>0;r--){const a=Math.floor(Math.random()*(r+1));[t[r],t[a]]=[t[a],t[r]]}return t}function ye(){if(!P||M.length===0)return;const e=M[G%M.length];P.src!==e.url&&(P.src=e.url,P.currentTime=0)}function z(){return P||(M=ir(or),G=0,P=new Audio,P.loop=!1,P.volume=.2,P.preload="auto",ye(),P.addEventListener("ended",()=>{M.length!==0&&(G=(G+1)%M.length,ye(),ne&&P.play().catch(()=>{}))})),P}function Se(e){const t=z();ne=e,e?t.play().catch(()=>{}):t.pause()}function qe(){const e=z();if(!e.paused)return;const t=e.currentTime,r=e.muted;e.muted=!0;const a=e.play();e.pause();try{e.currentTime=t}catch{}a.then(()=>{if(ne){e.muted=r,e.paused&&e.play().catch(()=>{});return}e.pause(),e.muted=r;try{e.currentTime=t}catch{}}).catch(()=>{e.muted=r})}function At(){const e=z();ne&&e.paused&&e.play().catch(()=>{})}function sr(){z(),M.length!==0&&(G=(G+1)%M.length,ye(),ne&&P.play().catch(()=>{}))}function cr(){z(),M.length!==0&&(G=(G-1+M.length)%M.length,ye(),ne&&P.play().catch(()=>{}))}function ue(){return!z().paused}function Ye(){return z().currentTime||0}function se(){const e=z();return Number.isFinite(e.duration)?e.duration:0}function Ke(e){const t=z();Number.isFinite(e)&&(t.currentTime=Math.max(0,Math.min(se()||Number.MAX_SAFE_INTEGER,e)))}function fe(){return z(),M.length===0?"":M[G%M.length].name}function Je(e){const t=z(),r=Math.max(0,Math.min(1,e));t.volume=r}function Qe(){return z().volume}const Le={"engine-import":"Loading the game engine",renderer:"Initializing graphics",scene:"Building the world view",world:"Creating the world model",assets:"Loading world assets","render-pipeline":"Preparing the render pipeline",systems:"Connecting game systems","world-loading":"Generating the starting area","shader-compilation":"Compiling graphics shaders",warmup:"Warming up the GPU",ready:"Ready"};function lr(){const e=typeof window>"u"?{width:0,height:0}:{width:window.innerWidth,height:window.innerHeight},t=typeof window>"u"||!Number.isFinite(window.devicePixelRatio)?1:window.devicePixelRatio,r=typeof navigator>"u"?"unknown":navigator.userAgent||navigator.platform||"unknown";return{viewport:e,dpr:t,platform:r}}function dr(e){if(e instanceof Error)return{name:e.name||"Error",message:e.message||"Unknown startup error",...e.stack?{stack:e.stack}:{}};if(typeof e=="string")return{name:"Error",message:e};try{return{name:"Error",message:JSON.stringify(e)||"Unknown startup error"}}catch{return{name:"Error",message:"Unknown startup error"}}}function pr(e,t,r={}){const a=lr(),o=dr(t);return{...a,...r,stage:e,stageLabel:Le[e],...o}}function ur(e){if(!e||typeof e!="object")return!1;const t=e;return typeof t.stage=="string"&&typeof t.stageLabel=="string"&&typeof t.message=="string"&&!!t.viewport&&typeof t.dpr=="number"}function Ie(e){if(document.pointerLockElement!==e)try{const t=e.requestPointerLock?.();typeof t?.catch=="function"&&t.catch(()=>{})}catch{}}async function fr(){return(await tr(()=>import("./Engine-DIV6Api3.js"),__vite__mapDeps([0,1,2,3,4]))).engine}function Ct({diagnosticView:e,diagnosticTime:t}={}){const r=C.useRef(null),a=C.useRef(0),o=f(m=>m.setPaused),i=f(m=>m.setInGame),s=f(m=>m.setGameStarted),l=f(m=>m.setLoading),p=f(m=>m.setStartupStage),h=f(m=>m.setStartupError),d=f(m=>m.restartToken),x=f(m=>m.gameStarted),w=f(m=>m.loading);C.useEffect(()=>{const m=()=>{const g=r.current;!g||e||Ie(g)},u=window;return u.__requestGameEntryPointerLock=m,()=>{u.__requestGameEntryPointerLock===m&&delete u.__requestGameEntryPointerLock}},[e]),C.useEffect(()=>{const m=a.current+1;a.current=m;const u=()=>a.current===m;let g=null,j=!1,v=!0,S="engine-import";const b=E=>{if(!v||!u()){u()&&g?.stop();return}const c=ur(E)?E:pr(S,E);console.error("Game startup failed:",c),g?.stop(),i(!1),l(!1),s(!1),h(c)};return(async()=>{const E=r.current;if(!(!E||!v)&&!(!x&&!e))try{const c=R=>{S=R,v&&u()&&p(R)};if(c("engine-import"),g=await fr(),!v)return;if(await g.start(E,{...e?{diagnosticView:e,diagnosticTime:t}:{},onBootStage:c}),!v){u()&&g.stop();return}j=!0,e?i(!0):(Ie(E),i(!0),o(!1),Se(!0),l(!1))}catch(c){b(c)}})().catch(b),()=>{v=!1,o(!1),i(!1),e||Se(!1),u()&&j&&g?.stop()}},[d,o,i,s,l,p,h,x,e,t]);const A=m=>m.preventDefault(),y=()=>{const m=r.current;m&&x&&!w&&!e&&(Ie(m),At(),window.__primeSfx?.())};return n.jsx("div",{style:{position:"fixed",inset:0,background:"#0b0d10"},children:n.jsx("canvas",{ref:r,onContextMenu:A,onClick:y,style:{width:"100%",height:"100%",display:"block"}})})}const hr=9,We=1/0;function gr(){return Array.from({length:hr},()=>({blockId:null,count:0}))}const oe=xt((e,t)=>({slots:gr(),add:(r,a=1)=>{if(r<=0||a<=0)return a;const o=t().slots.slice();let i=a;for(let s=0;s<o.length&&i>0;s++){const l=o[s];if(l.blockId===r&&l.count<We){const p=Math.min(We-l.count,i);l.count+=p,i-=p}}for(let s=0;s<o.length&&i>0;s++){const l=o[s];if(l.blockId===null||l.count===0){const p=Math.min(We,i);l.blockId=r,l.count=p,i-=p}}return e({slots:o}),i},consumeFromSelected:(r=1)=>{if(r<=0)return 0;const a=t().slots.slice(),o=f.getState().selectedSlot,i=a[o];if(!i||!i.blockId||i.count<=0)return 0;const s=Math.min(i.count,r);return i.count-=s,i.count===0&&(i.blockId=null),e({slots:a}),s},getSelectedBlockId:()=>{const r=f.getState().selectedSlot,a=t().slots[r];return!a||!a.blockId||a.count<=0?null:a.blockId},clearSelectedIfEmpty:()=>{const r=t().slots.slice(),a=f.getState().selectedSlot,o=r[a];o&&o.count<=0&&(o.blockId=null),e({slots:r})}}));function Fa(e,t=1){return oe.getState().add(e,t)}function Ia(){return oe.getState().getSelectedBlockId()}function Wa(){return oe.getState().consumeFromSelected(1)===1}function ja(){return oe.getState().slots.map(e=>({blockId:e.blockId,count:e.count}))}function et(e){const t=Array.from({length:9},(r,a)=>{const o=e[a];if(!o||typeof o!="object")return{blockId:null,count:0};const i=o.blockId===null||typeof o.blockId=="number"?o.blockId:null,s=Math.max(0,Math.floor(Number.isFinite(o.count)?o.count:0));return{blockId:i,count:s}});oe.setState({slots:t})}const mr="/assets/grass-DpbbaMGp.png",xr="/assets/dirt-DqnIcsTT.png",br="/assets/cobblestone-bSPKa8EI.png",wr="/assets/sand-Dwllyi-m.png",vr="/assets/wood-Br2imn7P.png",yr="/assets/branch-BMHqvNwM.png",Sr="/assets/cherry_branch-oq1HP-ay.png",Er="/assets/grass_leaves_icon-D13aQOUF.png",Rr="/assets/water-aOZMc5Uy.png",Ar={1:mr,2:xr,3:br,4:wr,5:Rr,6:vr,7:yr,8:Sr,9:Er};function Cr(){const e=f(o=>o.selectedSlot),t=f(o=>o.inGame),r=f(o=>o.loading),a=oe(o=>o.slots);return!t||r?null:n.jsx("div",{style:{position:"absolute",bottom:24,left:"50%",transform:"translateX(-50%)",display:"flex",gap:4,padding:4,background:"rgba(0,0,0,0.25)",borderRadius:6},children:a.map((o,i)=>{const s=i===e,l=o.blockId?Ar[o.blockId]:void 0;return n.jsxs("div",{style:{width:44,height:44,boxSizing:"border-box",border:"2px solid",borderColor:s?"#cfe9ef":"#555",background:"#6b6e63",boxShadow:s?"0 0 0 2px #1a1a1a inset":"0 0 0 1px #2a2a2a inset",position:"relative"},children:[l&&n.jsx("img",{src:l,alt:"",style:{width:32,height:32,imageRendering:"pixelated",position:"absolute",left:"50%",top:"50%",transform:"translate(-50%, -50%)"}}),n.jsx("div",{style:{position:"absolute",left:2,top:1,fontSize:10,color:"#d8b35e",textShadow:"1px 1px 0 #000",fontWeight:"bold"},children:i+1}),o.count>0&&n.jsx("div",{style:{position:"absolute",right:2,bottom:0,fontSize:10,color:"#fff",textShadow:"1px 1px 0 #000"},children:o.count})]},i)})})}function _r(){const e=f(a=>a.inGame),t=f(a=>a.loading),r=f(a=>a.paused);return!e||t||r?null:n.jsxs("div",{"aria-label":"Press R to switch character",style:{position:"absolute",left:"50%",bottom:84,transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:6,padding:"5px 9px",background:"rgba(8, 13, 18, 0.72)",border:"1px solid rgba(148,163,184,0.16)",borderRadius:7,color:"rgba(248,250,252,0.78)",fontSize:11,lineHeight:"16px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',letterSpacing:.2,pointerEvents:"none",backdropFilter:"blur(8px)",boxShadow:"0 6px 16px rgba(0,0,0,0.22)",zIndex:1001,whiteSpace:"nowrap"},children:[n.jsx("span",{children:"Press"}),n.jsx("kbd",{style:{minWidth:18,height:18,padding:"0 5px",boxSizing:"border-box",display:"inline-flex",alignItems:"center",justifyContent:"center",border:"1px solid rgba(226,232,240,0.34)",borderBottomWidth:2,borderRadius:4,background:"rgba(15,23,32,0.92)",color:"#f8fafc",fontSize:10,lineHeight:"14px",fontFamily:"inherit",fontWeight:800,letterSpacing:.5},children:"R"}),n.jsx("span",{children:"to switch character"})]})}function kr(){const e=f(o=>o.inGame),t=f(o=>o.loading),r=14,a=2;return!e||t?null:n.jsxs("div",{style:{position:"absolute",left:"50%",top:"50%",pointerEvents:"none"},children:[n.jsx("div",{style:{position:"absolute",width:r,height:a,background:"#fff",transform:"translate(-50%, -50%)"}}),n.jsx("div",{style:{position:"absolute",width:a,height:r,background:"#fff",transform:"translate(-50%, -50%)"}})]})}function Tr(){const e=f(x=>x.fps),t=f(x=>x.gameStarted),r=f(x=>x.loading),[a,o]=W.useState(0);W.useEffect(()=>{let x=0;const w=()=>{const A=window.getGraphicsSettings;if(A){const y=A();y&&y.timeOfDay&&o(y.timeOfDay.t)}x=requestAnimationFrame(w)};return x=requestAnimationFrame(w),()=>cancelAnimationFrame(x)},[]);const i=(6+a*24)%12,s=i%1*60,l=i/12*360,p=s/60*360,h=36,d=h/2;return!t||r?null:n.jsxs("div",{id:"top-right-widget",style:{position:"absolute",right:12,top:12,display:"flex",alignItems:"center",gap:"8px",padding:"8px 12px",background:"rgba(15, 23, 32, 0.94)",color:"#f8f9fa",border:"1px solid rgba(148,163,184,0.16)",borderRadius:"8px",fontSize:"12px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontWeight:600,letterSpacing:.3,pointerEvents:"none",backdropFilter:"blur(10px)",boxShadow:"0 8px 20px rgba(0,0,0,0.28)",zIndex:1001},children:[n.jsx("span",{style:{opacity:.8},children:"Press P to pause"}),n.jsx("div",{style:{width:"1px",height:"16px",background:"rgba(255,255,255,0.2)"}}),n.jsxs("span",{style:{color:"#2dd4bf",fontWeight:700,minWidth:"48px",textAlign:"center"},children:[e," fps"]}),n.jsx("div",{style:{width:"1px",height:"16px",background:"rgba(255,255,255,0.2)"}}),n.jsxs("div",{style:{width:h,height:h,borderRadius:"50%",border:"2px solid rgba(255,255,255,0.4)",background:"rgba(0,0,0,0.2)",position:"relative",flexShrink:0},children:[n.jsx("div",{style:{position:"absolute",left:d-1.5,top:d-8,width:3,height:8,background:"#fff",transformOrigin:"50% 100%",transform:`rotate(${l}deg)`,borderRadius:2}}),n.jsx("div",{style:{position:"absolute",left:d-.5,top:d-12,width:1,height:12,background:"#dde6ff",transformOrigin:"50% 100%",transform:`rotate(${p}deg)`,borderRadius:1}}),n.jsx("div",{style:{position:"absolute",left:d-1.5,top:d-1.5,width:3,height:3,background:"#fff",borderRadius:"50%"}})]})]})}function Fr(){const e=f(o=>o.paused),t=f(o=>o.gameStarted),r=f(o=>o.loading),a=f(o=>o.setPaused);return!e||!t||r?null:n.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",padding:"16px",background:"rgba(8, 13, 18, 0.76)",backdropFilter:"blur(2px)",zIndex:900,fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif'},children:n.jsxs("div",{style:{width:"100%",maxWidth:480,padding:"clamp(20px, 5vw, 32px)",boxSizing:"border-box",borderRadius:16,background:"rgba(15, 23, 32, 0.94)",border:"1px solid rgba(148,163,184,0.16)",boxShadow:"0 24px 60px rgba(0,0,0,0.48)",backdropFilter:"blur(20px)",color:"#f8f9fa"},children:[n.jsx("div",{style:{marginBottom:"clamp(16px, 4vw, 24px)",paddingBottom:16,borderBottom:"1px solid rgba(255,255,255,0.06)",fontSize:"clamp(24px, 6vw, 28px)",fontWeight:800,color:"#f8fafc"},children:"Game Paused"}),n.jsx("button",{onClick:()=>{a(!1),window.__requestGameEntryPointerLock?.()},style:{width:"100%",height:52,boxSizing:"border-box",padding:"12px 24px",display:"flex",alignItems:"center",justifyContent:"center",background:"#2dd4bf",color:"#061311",border:"1px solid rgba(94,234,212,0.5)",borderRadius:12,cursor:"pointer",fontWeight:700,fontSize:"clamp(14px, 3.5vw, 16px)",lineHeight:"20px",letterSpacing:.5,textTransform:"uppercase",boxShadow:"0 10px 24px rgba(0,0,0,0.32)",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",outline:"none"},onMouseOver:o=>{o.currentTarget.style.transform="translateY(-2px)",o.currentTarget.style.boxShadow="0 14px 30px rgba(0,0,0,0.38)",o.currentTarget.style.background="#5eead4"},onMouseOut:o=>{o.currentTarget.style.transform="translateY(0)",o.currentTarget.style.boxShadow="0 10px 24px rgba(0,0,0,0.32)",o.currentTarget.style.background="#2dd4bf"},children:"Resume Game"})]})})}const Ir=()=>{const e=f(b=>b.gameStarted),t=f(b=>b.loading),r=W.useRef(null),[a,o]=W.useState(!1),[i,s]=W.useState(0),[l,p]=W.useState(0),[h,d]=W.useState(""),[x,w]=W.useState(0),[A,y]=W.useState(84),[m,u]=W.useState(void 0),[g,j]=W.useState(!1),[v,S]=W.useState(!1);return W.useEffect(()=>{try{o(ue())}catch{}try{s(Ye()),p(se()),d(fe()),w(Qe())}catch{}},[]),W.useEffect(()=>{let b=0;const _=()=>{const E=Ye(),c=se(),R=ue(),O=fe(),B=Qe();s(E),p(c),o(R),d(O),w(B),b=requestAnimationFrame(_)};return b=requestAnimationFrame(_),()=>cancelAnimationFrame(b)},[]),W.useEffect(()=>{const b=()=>{const c=document.getElementById("top-right-widget");if(!c)return;const R=c.getBoundingClientRect();Number.isFinite(R.bottom)&&y(Math.ceil(R.bottom+12)),Number.isFinite(R.width)&&R.width>0&&u(Math.ceil(R.width))};b();const _=requestAnimationFrame(b);window.addEventListener("resize",b);const E=window.setInterval(b,100);return()=>{window.removeEventListener("resize",b),window.clearInterval(E),cancelAnimationFrame(_)}},[]),W.useEffect(()=>{const b=E=>{if(g){const c=document.querySelector("[data-progress-bar]");if(c){const R=c.getBoundingClientRect(),O=Math.min(1,Math.max(0,(E.clientX-R.left)/R.width)),B=se();B>0&&Ke(O*B)}}if(v){const c=document.querySelector("[data-volume-bar]");if(c){const R=c.getBoundingClientRect(),O=Math.min(1,Math.max(0,(E.clientX-R.left)/R.width));Je(O),w(O)}}},_=()=>{j(!1),S(!1)};if(g||v)return document.addEventListener("mousemove",b),document.addEventListener("mouseup",_),()=>{document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",_)}},[g,v]),!e||t||m===void 0?null:n.jsx("div",{ref:r,style:{position:"fixed",right:12,top:A,width:m,minWidth:0,boxSizing:"border-box",overflow:"hidden",background:"rgba(15, 23, 32, 0.94)",border:"1px solid rgba(148,163,184,0.16)",borderRadius:"12px",padding:"8px 12px",color:"#ffffff",fontSize:"14px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',zIndex:1001,pointerEvents:"auto",backdropFilter:"blur(24px)",boxShadow:"0 8px 20px rgba(0,0,0,0.28)"},children:n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"4px",minWidth:0},children:[n.jsx("div",{style:{alignSelf:"flex-start",fontSize:13,fontWeight:800,color:"#f8fafc",letterSpacing:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:"100%"},children:h||"—"}),n.jsx("div",{"data-progress-bar":!0,onClick:b=>{const _=b.currentTarget.getBoundingClientRect(),E=Math.min(1,Math.max(0,(b.clientX-_.left)/_.width)),c=se();c>0&&Ke(E*c)},onMouseDown:b=>{b.preventDefault(),j(!0)},style:{width:"100%",height:"8px",borderRadius:"6px",background:"rgba(255,255,255,0.12)",cursor:"pointer",position:"relative"},children:n.jsx("div",{style:{position:"absolute",left:0,top:0,bottom:0,width:`${l>0?Math.min(1,i/l)*100:0}%`,background:"#2dd4bf",borderRadius:"6px"}})}),n.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"12px",minWidth:0},children:[n.jsx("button",{"aria-label":"Previous track",onClick:()=>{cr(),o(ue()),d(fe())},style:{padding:"6px 8px",background:"transparent",border:"none",color:"#e2e8f0",cursor:"pointer",fontSize:"22px"},children:n.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":!0,children:n.jsx("path",{d:"M18 7v10l-6-5 6-5zM10 7v10L4 12l6-5z"})})}),n.jsx("button",{"aria-label":a?"Pause":"Play",onClick:()=>{a?(Se(!1),o(!1)):(Se(!0),At(),o(!0))},style:{padding:"6px 8px",background:"transparent",border:"none",color:"#e2e8f0",cursor:"pointer",fontSize:"26px"},children:a?n.jsx("svg",{width:"26",height:"26",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":!0,children:n.jsx("path",{d:"M6 5h4v14H6zM14 5h4v14h-4z"})}):n.jsx("svg",{width:"26",height:"26",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":!0,children:n.jsx("path",{d:"M8 5v14l11-7-11-7z"})})}),n.jsx("button",{"aria-label":"Next track",onClick:()=>{sr(),o(ue()),d(fe())},style:{padding:"6px 8px",background:"transparent",border:"none",color:"#e2e8f0",cursor:"pointer",fontSize:"22px"},children:n.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":!0,children:n.jsx("path",{d:"M6 7v10l6-5-6-5zm8 0v10l6-5-6-5z"})})})]}),n.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"6px",marginTop:"1px",minWidth:0},children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",style:{color:"#94a3b8",flexShrink:0},children:n.jsx("path",{d:"M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"})}),n.jsx("div",{"data-volume-bar":!0,onClick:b=>{const _=b.currentTarget.getBoundingClientRect(),E=Math.min(1,Math.max(0,(b.clientX-_.left)/_.width));Je(E),w(E)},onMouseDown:b=>{b.preventDefault(),S(!0)},style:{flex:1,height:"6px",borderRadius:"4px",background:"rgba(255,255,255,0.12)",cursor:"pointer",position:"relative",minWidth:0},children:n.jsx("div",{style:{position:"absolute",left:0,top:0,bottom:0,width:`${x*100}%`,background:"#2dd4bf",borderRadius:"4px"}})}),n.jsxs("span",{style:{fontSize:"11px",color:"#94a3b8",minWidth:"28px",textAlign:"right"},children:[Math.round(x*100),"%"]})]})]})})},Wr={dayNightCycleSeconds:1200,shadows:{enabled:!0,distance:300,intensity:1,character:{maxDistance:32}},bloom:{enabled:!0,strength:.08,radius:.28,threshold:1.05},lens:{enabled:!0,intensity:.32},atmosphere:{rayleighScaleHeight:8,mieScaleHeight:1.2,rayleighCoefficient:.055,mieCoefficient:.018,mieDirectionalG:.76,absorptionCoefficient:.004,skyRadianceScale:1.25,aerosolStrength:.14,aerialPerspectiveStart:96,aerialPerspectiveExtinction:.0022,aerialPerspectiveMax:.72,horizonHazeWidth:.26,horizonHazeStrength:1,horizonHazeNearSurfaceFloor:.04}};function jr(){const e=f(a=>a.setLoading),t=f(a=>a.gameStarted),r=f(a=>a.loading);return!t||r?null:n.jsxs("button",{onClick:async()=>{e(!0);try{const a=window;if(typeof a.showSaveFilePicker=="function")try{const o=`mycraft-world-${new Date().toISOString().replace(/[:.]/g,"-").replace("T","_").replace("Z","")}.json`,i=await a.showSaveFilePicker({suggestedName:o,types:[{description:"MyCraft World (JSON)",accept:{"application/json":[".json"]}}]});a.__nextSaveFileHandle=i}catch(o){const i=o?.name;if(i==="AbortError"||i==="NotAllowedError"){e(!1);return}console.warn("Save picker failed; falling back to default download.",o)}window.__saveWorld?.(),await new Promise(o=>setTimeout(o,500))}catch(a){console.error("Save failed:",a)}finally{e(!1)}},style:{padding:"8px 12px",background:"rgba(15, 23, 32, 0.94)",color:"#f8f9fa",border:"1px solid rgba(148,163,184,0.16)",borderRadius:"8px",cursor:"pointer",fontSize:"12px",lineHeight:"16px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontWeight:600,letterSpacing:.3,pointerEvents:"auto",backdropFilter:"blur(10px)",boxShadow:"0 8px 20px rgba(0,0,0,0.28)",transition:"all 0.2s ease",display:"flex",alignItems:"center",gap:"6px",width:"fit-content"},onMouseOver:a=>{a.currentTarget.style.transform="translateY(-2px)",a.currentTarget.style.boxShadow="0 12px 26px rgba(0,0,0,0.34)",a.currentTarget.style.borderColor="rgba(94,234,212,0.38)",a.currentTarget.style.background="rgba(20, 31, 43, 0.98)"},onMouseOut:a=>{a.currentTarget.style.transform="translateY(0)",a.currentTarget.style.boxShadow="0 8px 20px rgba(0,0,0,0.28)",a.currentTarget.style.borderColor="rgba(148,163,184,0.16)",a.currentTarget.style.background="rgba(15, 23, 32, 0.94)"},children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",style:{width:14,height:14,display:"block",flexShrink:0},children:n.jsx("path",{d:"M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z",fill:"currentColor",opacity:"0.8"})}),n.jsx("span",{children:"Save World"})]})}const Dr={position:"fixed",top:"52px",left:"12px",width:"320px",background:"rgba(15, 23, 32, 0.98)",border:"1px solid rgba(148,163,184,0.16)",borderRadius:"16px",padding:"20px",color:"#f8f9fa",fontSize:"13px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',zIndex:2e3,maxHeight:"80vh",overflowY:"auto",backdropFilter:"blur(20px)",boxShadow:"0 24px 60px rgba(0,0,0,0.48)"},tt={marginBottom:"20px"},je={margin:"0 0 12px 0",fontSize:"14px",color:"#e2e8f0",fontWeight:600,textTransform:"uppercase",letterSpacing:.5,borderBottom:"1px solid rgba(255,255,255,0.06)",paddingBottom:"6px"},rt={display:"block",padding:"8px 12px",borderRadius:"8px",background:"rgba(255,255,255,0.025)"},Pr=()=>{const{debugVisible:e,setDebugVisible:t,setAudioVisible:r}=f(),a=f(u=>u.playerCharacter),o=f(u=>u.setPlayerCharacter),i=f(u=>u.gameStarted),s=f(u=>u.loading),l=C.useRef(null),[p,h]=C.useState(.7),[d,x]=C.useState(0),[w,A]=C.useState(!1);if(C.useEffect(()=>{const g=window.__getSfxVolume?.();typeof g=="number"&&Number.isFinite(g)&&h(g)},[]),C.useEffect(()=>{let u=0;const g=()=>{const j=window.getGraphicsSettings?.();if(j?.timeOfDay){const v=j.timeOfDay.t;Number.isFinite(v)&&x(S=>Math.abs(S-v)>1e-4?v:S),A(j.timeOfDay.paused)}u=requestAnimationFrame(g)};return u=requestAnimationFrame(g),()=>cancelAnimationFrame(u)},[]),C.useEffect(()=>{if(!e)return;const u=g=>{l.current&&!l.current.contains(g.target)&&t(!1)};return document.addEventListener("mousedown",u,!0),()=>document.removeEventListener("mousedown",u,!0)},[e,t]),C.useEffect(()=>{e&&r(!1)},[e,r]),!i||s)return null;if(!e)return n.jsxs("div",{style:{position:"fixed",top:"12px",left:"12px",zIndex:1e3,display:"flex",flexDirection:"column",gap:"10px"},children:[n.jsxs("button",{onClick:()=>{r(!1),t(!0)},style:{padding:"8px 12px",background:"rgba(15, 23, 32, 0.94)",color:"#f8f9fa",border:"1px solid rgba(148,163,184,0.16)",borderRadius:"8px",cursor:"pointer",fontSize:"12px",lineHeight:"16px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontWeight:600,letterSpacing:.3,pointerEvents:"auto",backdropFilter:"blur(10px)",boxShadow:"0 8px 20px rgba(0,0,0,0.28)",display:"flex",alignItems:"center",gap:"6px"},children:[n.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true",style:{width:14,height:14,display:"block",flexShrink:0},children:n.jsx("path",{d:"M19.43 12.98c.04-.32.07-.65.07-.98s-.02-.66-.07-.98l2.11-1.65c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.37-.31-.6-.22l-2.49 1c-.52-.4-1.08-.73-1.69-.98L14.5 1.42C14.47 1.18 14.25 1 14 1h-4c-.25 0-.46.18-.5.42L9.12 4.07c-.61.25-1.17.59-1.69.98l-2.49-1c-.23-.08-.48 0-.6.22l-2 3.46c-.13.22-.07.49.12.64l2.11 1.65c-.04.32-.08.65-.08.98s.03.66.08.98l-2.11 1.65c-.19.15-.24.42-.12.64l2 3.46c.12.22.37.31.6.22l2.49-1c.52.4 1.08.73 1.69.98l.38 2.65c.04.24.25.42.5.42h4c.25 0 .46-.18.5-.42l.38-2.65c.61-.25 1.17-.58 1.69-.98l2.49 1c.23.08.48 0 .6-.22l2-3.46c.12-.22.07-.49-.12-.64l-2.11-1.65zM12 15.5A3.5 3.5 0 1 1 12 8a3.5 3.5 0 0 1 0 7.5z"})}),n.jsx("span",{children:"Settings"})]}),n.jsx(jr,{})]});const y=(u,g=w)=>{x(u),window.updateGraphicsSettings?.({timeOfDay:{t:u,paused:g,cycleSeconds:Wr.dayNightCycleSeconds}})},m=u=>{const g=window.__setPlayerCharacter;g?g(u):o(u)};return n.jsxs("div",{ref:l,style:Dr,children:[n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"20px",paddingBottom:"16px",borderBottom:"1px solid rgba(255,255,255,0.06)",position:"sticky",top:0,background:"rgba(15, 23, 32, 0.98)",zIndex:1},children:[n.jsx("h3",{style:{margin:0,fontSize:"18px",fontWeight:700,color:"#f8fafc"},children:"Settings"}),n.jsx("button",{onClick:()=>t(!1),"aria-label":"Close settings",style:{background:"rgba(148,163,184,0.10)",border:"1px solid rgba(148,163,184,0.16)",color:"#f8f9fa",cursor:"pointer",padding:"8px 10px",borderRadius:"8px",fontSize:"14px",fontWeight:600},children:"✕"})]}),n.jsxs("section",{style:tt,children:[n.jsx("h4",{style:je,children:"Player"}),n.jsx("div",{role:"radiogroup","aria-label":"Player character",style:{display:"grid",gridTemplateColumns:"repeat(2, minmax(0, 1fr))",gap:"8px"},children:rr.map(u=>{const g=u.id===a;return n.jsxs("button",{type:"button",role:"radio","aria-checked":g,"aria-label":`${u.name}${g?" selected":""}`,onClick:()=>m(u.id),style:{minHeight:"64px",display:"flex",flexDirection:"column",alignItems:"flex-start",justifyContent:"center",gap:"5px",padding:"10px 12px",borderRadius:"10px",border:g?`2px solid ${u.accent}`:"1px solid rgba(148,163,184,0.18)",background:g?`linear-gradient(135deg, ${u.accent}24, rgba(255,255,255,0.06))`:"rgba(255,255,255,0.035)",color:"#f8fafc",cursor:"pointer",textAlign:"left",font:"inherit",boxShadow:g?`0 0 18px ${u.accent}1c`:"none"},children:[n.jsx("span",{style:{fontSize:"13px",lineHeight:"16px",fontWeight:700},children:u.name}),n.jsx("span",{style:{color:g?u.accent:"#64748b",fontSize:"10px",lineHeight:"12px",fontWeight:700,letterSpacing:.45,textTransform:"uppercase"},children:g?"Selected":"Choose"})]},u.id)})})]}),n.jsxs("section",{style:tt,children:[n.jsx("h4",{style:je,children:"Sound Effects"}),n.jsxs("label",{style:rt,children:[n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"6px",fontSize:"12px",fontWeight:500,color:"#94a3b8"},children:[n.jsx("span",{children:"Sound Effects Volume"}),n.jsxs("span",{style:{color:"#e2e8f0"},children:[Math.round(p*100),"%"]})]}),n.jsx("input",{"aria-label":"Sound Effects Volume",type:"range",min:0,max:1,step:.01,value:p,onChange:u=>{const g=Number.parseFloat(u.target.value);h(g),window.__setSfxVolume?.(g)},style:{width:"100%",height:"4px",borderRadius:"2px",background:"rgba(255,255,255,0.1)",outline:"none",cursor:"pointer"}})]})]}),n.jsxs("section",{style:{marginBottom:0},children:[n.jsx("h4",{style:je,children:"Day/Night Cycle"}),n.jsxs("label",{style:{display:"flex",alignItems:"center",marginBottom:"10px",cursor:"pointer",padding:"8px 12px",borderRadius:"8px",background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)"},children:[n.jsx("input",{type:"checkbox",checked:w,onChange:u=>{const g=u.target.checked;A(g),y(d,g)},style:{marginRight:"10px",transform:"scale(1.1)"}}),n.jsx("span",{style:{fontWeight:500},children:"Pause Cycle"})]}),n.jsxs("label",{style:rt,children:[n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"6px",fontSize:"12px",fontWeight:500,color:"#94a3b8"},children:[n.jsx("span",{children:"Time"}),n.jsx("span",{style:{color:"#e2e8f0"},children:d.toFixed(2)})]}),n.jsx("input",{"aria-label":"Time",type:"range",min:0,max:1,step:.01,value:d,onChange:u=>y(Number.parseFloat(u.target.value)),style:{width:"100%",height:"4px",borderRadius:"2px",background:"rgba(255,255,255,0.1)",outline:"none",cursor:"pointer"}}),n.jsx("div",{style:{marginTop:"8px",color:"#64748b",fontSize:"11px"},children:"10 min day · 10 min night"})]})]})]})},Mr="MC-HMAC-SHA256-v1",Nr="MyCraft-Local-Signing-Key-v1",Or="mycraft.local.secret.v1.very-insecure",Lr="MC-AES-GCM-256-v1",zr="a1c3f5b7d9e2c4a6b8d0f2e4c6a8b0d2a4c6e8f0b2d4f6a8c0e2f4a6c8e0f2a4";function $e(e){return JSON.stringify(e)}function Be(e){return new TextEncoder().encode(e)}function Ee(e){let t="";for(let r=0;r<e.length;r++)t+=String.fromCharCode(e[r]);return btoa(t)}function ce(e){const t=atob(e),r=new Uint8Array(t.length);for(let a=0;a<t.length;a++)r[a]=t.charCodeAt(a);return r}async function _t(){const e=new TextEncoder().encode(Or);return crypto.subtle.importKey("raw",e,{name:"HMAC",hash:"SHA-256"},!1,["sign","verify"])}async function Da(e){const t=await _t(),r=Be($e(e)),a=await crypto.subtle.sign("HMAC",t,r);return Ee(new Uint8Array(a))}async function Hr(e,t){const r=await _t(),a=Be($e(e)),o=ce(t);return crypto.subtle.verify("HMAC",r,o,a)}function Vr(e){const t=e.replace(/[^0-9a-f]/gi,""),r=new Uint8Array(t.length/2);for(let a=0;a<t.length;a+=2)r[a/2]=parseInt(t.substr(a,2),16);return r}async function kt(){const e=Vr(zr);return crypto.subtle.importKey("raw",e,{name:"AES-GCM"},!1,["encrypt","decrypt"])}async function Pa(e){const t=await kt(),r=crypto.getRandomValues(new Uint8Array(12)),a=Be($e(e)),o=await crypto.subtle.encrypt({name:"AES-GCM",iv:r},t,a);return{ivB64:Ee(r),cipherB64:Ee(new Uint8Array(o))}}async function $r(e,t){const r=await kt(),a=ce(e),o=ce(t),i=await crypto.subtle.decrypt({name:"AES-GCM",iv:a},r,o),s=new TextDecoder().decode(i);return JSON.parse(s)}const ee={x:64,y:128,z:64},Ue={height:1.8,width:.6,initialYaw:Math.PI,eyeHeight:1.7,speed:{walk:4,sprint:6},jump:8,gravity:-24,swim:{accel:14,verticalAccel:12,drag:3.2,maxSpeed:3.6,sprintMultiplier:1.5,gravityScale:.18,floatBand:1.25,floatStrength:4,surfaceSnapStrength:10,sinkBias:.6,maxEmergeStepOut:2.8,stepOutHeadroom:1.01,emergeLiftSpeed:6,emergeNudgeSpeed:2.4}},Ma={reach:5},Na=(.22+.18)*(2/3);function he(){if(typeof navigator>"u")return!1;const e=(navigator.userAgent||"").toLowerCase();return/android|iphone|ipad|ipod|iemobile|mobile|blackberry|bb10|silk|kindle/.test(e)?!0:!!(navigator.platform==="MacIntel"&&(navigator.maxTouchPoints||0)>1)}function at(){if(typeof navigator>"u")return!1;const e=navigator.userAgent,t=/Safari/i.test(e),r=/Chrome|CriOS|Chromium|Edg|OPR|FxiOS/i.test(e);return t&&!r}const Br="/assets/bg_img-DPvUbRQE.png";function Ur({value:e,onChange:t,disabled:r=!1}){const a=C.useRef([]),o=He(e)??H[0],i=H.findIndex(p=>p.id===o.id),s=p=>{const h=H[p];h&&(t(h.chunkCount),a.current[p]?.focus())},l=(p,h)=>{let d=null;p.key==="ArrowRight"||p.key==="ArrowDown"?d=(h+1)%H.length:p.key==="ArrowLeft"||p.key==="ArrowUp"?d=(h-1+H.length)%H.length:p.key==="Home"?d=0:p.key==="End"&&(d=H.length-1),d!==null&&(p.preventDefault(),s(d))};return n.jsx("div",{className:"world-size-picker",role:"radiogroup","aria-label":"World size",children:H.map((p,h)=>{const d=p.id===o.id,x=p.side,w=x*x,A=Math.floor(w/2);return n.jsxs("button",{ref:y=>{a.current[h]=y},type:"button",role:"radio","aria-checked":d,"aria-label":`${p.label}, ${p.side} by ${p.side} chunks`,tabIndex:h===i?0:-1,disabled:r,className:`world-size-picker__option${d?" world-size-picker__option--selected":""}`,onClick:()=>t(p.chunkCount),onKeyDown:y=>l(y,h),children:[n.jsx("span",{className:"world-size-picker__topline",children:n.jsx("span",{className:"world-size-picker__name",children:p.label})}),n.jsx("span",{className:"world-size-picker__map",style:{gridTemplateColumns:`repeat(${x}, minmax(0, 1fr))`},"aria-hidden":"true",children:Array.from({length:w},(y,m)=>n.jsx("span",{className:`world-size-picker__cell${m===A?" world-size-picker__cell--center":""}`},`${p.id}-${m}`))}),n.jsxs("span",{className:"world-size-picker__meta",children:[p.chunkCount," chunks"]})]},p.id)})})}const ge=52;function nt(){return n.jsx("span",{"aria-hidden":"true",style:{width:16,height:16,border:"2px solid currentColor",borderTopColor:"transparent",borderRadius:"50%",animation:"mycraft-button-spin 0.8s linear infinite",boxSizing:"border-box",display:"block",flex:"0 0 auto"}})}function ie(){window.__requestGameEntryPointerLock?.()}function Xr(){const e=f(c=>c.gameStarted),t=f(c=>c.setGameStarted),r=f(c=>c.chunkCount),a=f(c=>c.setChunkCount),o=f(c=>c.setInGame),i=f(c=>c.setPaused),s=f(c=>c.setLoading),l=f(c=>c.setStartupStage),p=f(c=>c.setStartupError),h=f(c=>c.startupStage),d=f(c=>c.startupError),x=f(c=>c.loading),w=()=>p(null),[A,y]=C.useState(()=>Oe(r)),[m,u]=C.useState(!1),[g,j]=C.useState(null),v=C.useRef(null);C.useEffect(()=>{y(Oe(r))},[r]),C.useEffect(()=>{const c=R=>{v.current&&!v.current.contains(R.target)&&u(!1)};return m&&document.addEventListener("mousedown",c),()=>{document.removeEventListener("mousedown",c)}},[m]),C.useEffect(()=>{x||(j(null),l(null))},[x,l]);const S=x?g:null;if(e&&S===null)return null;const b=async()=>{if(he()||at()&&!he()){alert("Please visit it on desktop, and in Chrome or other Chromium browsers.");return}try{w(),j("load"),o(!1),i(!1),s(!0),qe(),ie();const c=document.createElement("input");c.type="file",c.accept="application/json",c.oncancel=()=>{s(!1)},c.oninput=()=>{ie()},c.onchange=async()=>{const R=c.files?.[0];if(!R){s(!1);return}ie();const O=await R.text();let B;try{B=JSON.parse(O)}catch{alert("Invalid JSON file."),s(!1);return}const T=B;let V;if(T.kind!=="MyCraftWorld"){alert("Not a MyCraft world save."),s(!1);return}if(T.version!==2||T.encAlg!==Lr){alert("Save file version not supported."),s(!1);return}if(T.publicKeyId!==Nr||T.signatureAlg!==Mr){alert("Save file not recognized (metadata mismatch)."),s(!1);return}if(!T.ivB64||!T.cipherB64||!T.signatureB64){alert("Save file missing fields (iv/cipher/signature)."),s(!1);return}try{V=await $r(T.ivB64,T.cipherB64)}catch(F){console.error("Decryption failed:",F),alert("Save file decryption failed. The file may be corrupted."),s(!1);return}const $=T.signatureB64;if(typeof $!="string"||!$){alert("Save file missing signature."),s(!1);return}try{const F=ce($);if(Ee(F)!==$){alert("Save signature is malformed (base64 altered)."),s(!1);return}if(!await Hr(V,$)){alert("Save signature verification failed (data may be corrupted)."),s(!1);return}}catch(F){console.error("Signature verification error:",F),alert("Unable to verify save signature. The file may be corrupted or browser crypto is unavailable."),s(!1);return}const k=V.settings.chunkSize;if(!k||typeof k.x!="number"||typeof k.y!="number"||typeof k.z!="number"){alert("Save file missing chunk size."),s(!1);return}if(k.x!==ee.x||k.y!==ee.y||k.z!==ee.z){alert(`Save chunk size ${k.x}x${k.y}x${k.z} does not match game chunk size ${ee.x}x${ee.y}x${ee.z}.`),s(!1);return}const ke=He(V.settings.chunkCount);if(!ke){const F=H.map(I=>I.label).join(", ");alert(`Save world size is not supported. Choose one of: ${F}.`),s(!1);return}if(!Array.isArray(V.chunks)||V.chunks.length===0){alert("Save has no chunks."),s(!1);return}const Te=k.x*k.y*k.z;for(const F of V.chunks){if(!F||typeof F!="object"){alert("Save chunk entry invalid."),s(!1);return}const{key:I,cx:de,cy:pe,cz:Fe,size:ae,voxelsB64:U}=F;if(typeof I!="string"||`${de},${pe},${Fe}`!==I){alert("Save chunk key mismatch."),s(!1);return}if(!ae||ae.x!==k.x||ae.y!==k.y||ae.z!==k.z){alert("Save chunk size mismatch."),s(!1);return}if(typeof U!="string"||!U){alert("Save chunk data missing."),s(!1);return}try{if(ce(U).length!==Te){alert("Save chunk data corrupted (length mismatch)."),s(!1);return}}catch(q){console.error("Chunk decode error:",q),alert("Save chunk data is not valid base64."),s(!1);return}}const re=V.inventory;if(re){const F=Array.isArray(re.slots)?re.slots:[];if(F.length!==9){alert("Save inventory invalid (must have 9 slots)."),s(!1);return}if(et(F.map(I=>({blockId:I&&(I.blockId===null||typeof I.blockId=="number")?I.blockId:null,count:Math.max(0,Math.floor(I&&typeof I.count=="number"?I.count:0))}))),typeof re.selectedSlot=="number"){const I=Math.max(0,Math.min(8,Math.floor(re.selectedSlot)));f.getState().setSelectedSlot(I)}}else et(Array.from({length:9},()=>({blockId:null,count:0}))),f.getState().setSelectedSlot(0);window.__WORLD_SNAPSHOT=V,window.__WORLD_SNAPSHOT_VERIFIED=!0,a(ke.chunkCount),t(!0)},c.click(),ie()}catch(c){console.error("Load world failed:",c),alert("Failed to load world save."),s(!1)}},_=he()||at()&&!he(),E=()=>{if(_){alert("Please visit it on desktop, and in Chrome or other Chromium browsers.");return}w(),a(A),delete window.__WORLD_SNAPSHOT,delete window.__WORLD_SNAPSHOT_VERIFIED,j("new"),o(!1),i(!1),s(!0),qe(),ie(),t(!0)};return n.jsxs("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",padding:"16px 0",boxSizing:"border-box",overflowY:"auto",backgroundImage:`url(${Br})`,backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",color:"#f8f9fa",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif'},children:[n.jsx("div",{style:{position:"absolute",inset:0,background:"rgba(8, 13, 18, 0.76)",backdropFilter:"blur(2px)"}}),n.jsxs("div",{style:{width:"100%",maxWidth:480,margin:"0 16px",padding:"clamp(20px, 5vw, 32px)",borderRadius:16,background:"rgba(15, 23, 32, 0.94)",border:"1px solid rgba(148,163,184,0.16)",boxShadow:"0 24px 60px rgba(0,0,0,0.48)",backdropFilter:"blur(20px)",position:"relative",zIndex:1,boxSizing:"border-box",maxHeight:"calc(100dvh - 32px)",overflowY:"auto"},children:[n.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"clamp(16px, 4vw, 24px)",paddingBottom:16,borderBottom:"1px solid rgba(255,255,255,0.06)",flexWrap:"wrap",gap:8},children:[n.jsx("div",{style:{fontSize:"clamp(24px, 6vw, 28px)",fontWeight:800,letterSpacing:0,color:"#f8fafc"},children:"MyCraft"}),n.jsxs("div",{ref:v,style:{position:"relative",display:"flex",alignItems:"center",gap:8},children:[n.jsxs("div",{onClick:()=>u(!m),style:{opacity:1,fontSize:14,fontWeight:700,color:"#e2e8f0",cursor:"pointer",display:"flex",alignItems:"center",gap:6,padding:"6px 12px",borderRadius:8,transition:"all 0.2s ease",userSelect:"none",background:"rgba(148,163,184,0.1)",border:"1px solid rgba(148,163,184,0.2)"},onMouseOver:c=>{c.currentTarget.style.opacity="1",c.currentTarget.style.background="rgba(148,163,184,0.2)",c.currentTarget.style.borderColor="rgba(148,163,184,0.3)",c.currentTarget.style.transform="translateY(-1px)"},onMouseOut:c=>{c.currentTarget.style.opacity="1",c.currentTarget.style.background="rgba(148,163,184,0.1)",c.currentTarget.style.borderColor="rgba(148,163,184,0.2)",c.currentTarget.style.transform="translateY(0)"},children:["Player Control",n.jsx("span",{style:{fontSize:10,transform:m?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.2s ease"},children:"▼"})]}),m&&n.jsxs("div",{style:{position:"absolute",top:"100%",right:0,marginTop:8,minWidth:"clamp(240px, 70vw, 320px)",maxWidth:"min(90vw, 320px)",padding:"clamp(12px, 3vw, 16px)",background:"rgba(12, 18, 26, 0.98)",border:"1px solid rgba(148,163,184,0.18)",borderRadius:"clamp(8px, 2vw, 12px)",boxShadow:"0 12px 32px rgba(0,0,0,0.6), 0 4px 16px rgba(0,0,0,0.4)",backdropFilter:"blur(20px)",zIndex:10,animation:"fadeIn 0.2s ease-out",transform:"translateX(min(0px, calc(-100% + 100vw - 32px)))"},children:[n.jsx("div",{style:{fontSize:"clamp(11px, 2.5vw, 12px)",fontWeight:600,color:"#e2e8f0",marginBottom:"clamp(8px, 2vw, 12px)",textAlign:"center",letterSpacing:.5},children:"PLAYER CONTROLS"}),n.jsxs("div",{style:{display:"grid",gap:"clamp(16px, 4vw, 20px)"},children:[n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start"},children:[n.jsx("span",{style:{fontSize:"clamp(12px, 2.8vw, 13px)",color:"#cbd5e1",marginTop:"clamp(8px, 2vw, 12px)"},children:"Movement"}),n.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gridTemplateRows:"repeat(2, 1fr)",gap:"clamp(3px, 1vw, 4px)",width:"clamp(90px, 22vw, 108px)",height:"clamp(60px, 14vw, 72px)"},children:[n.jsx("div",{}),n.jsx("kbd",{style:{width:"100%",height:"100%",background:"#1f2937",color:"#f3f4f6",borderRadius:"clamp(4px, 1vw, 6px)",fontSize:"clamp(10px, 2.2vw, 12px)",fontWeight:700,border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 2px 4px rgba(0,0,0,0.3), inset 0 1px 2px rgba(255,255,255,0.1)",display:"flex",alignItems:"center",justifyContent:"center"},children:"W"}),n.jsx("div",{}),n.jsx("kbd",{style:{width:"100%",height:"100%",background:"#1f2937",color:"#f3f4f6",borderRadius:"clamp(4px, 1vw, 6px)",fontSize:"clamp(10px, 2.2vw, 12px)",fontWeight:700,border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 2px 4px rgba(0,0,0,0.3), inset 0 1px 2px rgba(255,255,255,0.1)",display:"flex",alignItems:"center",justifyContent:"center"},children:"A"}),n.jsx("kbd",{style:{width:"100%",height:"100%",background:"#1f2937",color:"#f3f4f6",borderRadius:"clamp(4px, 1vw, 6px)",fontSize:"clamp(10px, 2.2vw, 12px)",fontWeight:700,border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 2px 4px rgba(0,0,0,0.3), inset 0 1px 2px rgba(255,255,255,0.1)",display:"flex",alignItems:"center",justifyContent:"center"},children:"S"}),n.jsx("kbd",{style:{width:"100%",height:"100%",background:"#1f2937",color:"#f3f4f6",borderRadius:"clamp(4px, 1vw, 6px)",fontSize:"clamp(10px, 2.2vw, 12px)",fontWeight:700,border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 2px 4px rgba(0,0,0,0.3), inset 0 1px 2px rgba(255,255,255,0.1)",display:"flex",alignItems:"center",justifyContent:"center"},children:"D"})]})]}),n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[n.jsx("span",{style:{fontSize:"clamp(12px, 2.8vw, 13px)",color:"#cbd5e1"},children:"Sprint"}),n.jsx("kbd",{style:{padding:"0 clamp(16px, 4vw, 20px)",background:"#1f2937",color:"#f3f4f6",borderRadius:"clamp(4px, 1vw, 6px)",fontSize:"clamp(10px, 2.2vw, 12px)",fontWeight:700,border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 2px 4px rgba(0,0,0,0.3), inset 0 1px 2px rgba(255,255,255,0.1)",height:"clamp(28px, 7vw, 34px)",display:"flex",alignItems:"center",justifyContent:"center"},children:"SHIFT"})]}),n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[n.jsx("span",{style:{fontSize:"clamp(12px, 2.8vw, 13px)",color:"#cbd5e1"},children:"Jump / Surface"}),n.jsx("kbd",{style:{padding:"0 clamp(28px, 7vw, 36px)",background:"#1f2937",color:"#f3f4f6",borderRadius:"clamp(4px, 1vw, 6px)",fontSize:"clamp(10px, 2.2vw, 12px)",fontWeight:700,border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 2px 4px rgba(0,0,0,0.3), inset 0 1px 2px rgba(255,255,255,0.1)",height:"clamp(28px, 7vw, 34px)",minWidth:"clamp(90px, 22vw, 110px)",display:"flex",alignItems:"center",justifyContent:"center"},children:"SPACE"})]}),n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[n.jsx("span",{style:{fontSize:"clamp(12px, 2.8vw, 13px)",color:"#cbd5e1"},children:"Break Block"}),n.jsxs("div",{style:{position:"relative",width:"clamp(50px, 12vw, 60px)",height:"clamp(35px, 8vw, 42px)",background:"#2a3442",borderRadius:"clamp(15px, 4vw, 18px) clamp(15px, 4vw, 18px) clamp(8px, 2vw, 10px) clamp(8px, 2vw, 10px)",border:"1.5px solid rgba(255,255,255,0.2)",boxShadow:"0 3px 12px rgba(0,0,0,0.5), inset 0 1px 3px rgba(255,255,255,0.15)",display:"flex",alignItems:"center",justifyContent:"center",cursor:"default"},children:[n.jsx("div",{style:{position:"absolute",left:"12%",top:"15%",width:"35%",height:"50%",background:"#2dd4bf",borderRadius:"clamp(6px, 1.5vw, 8px) clamp(6px, 1.5vw, 8px) clamp(2px, 0.5vw, 3px) clamp(2px, 0.5vw, 3px)",border:"2px solid rgba(94,234,212,0.7)",boxShadow:"inset 0 1px 3px rgba(0,0,0,0.24)"}}),n.jsx("div",{style:{position:"absolute",right:"12%",top:"15%",width:"35%",height:"50%",background:"#3d4654",borderRadius:"clamp(6px, 1.5vw, 8px) clamp(6px, 1.5vw, 8px) clamp(2px, 0.5vw, 3px) clamp(2px, 0.5vw, 3px)",border:"1px solid rgba(255,255,255,0.15)",boxShadow:"inset 0 1px 3px rgba(0,0,0,0.3), 0 1px 2px rgba(255,255,255,0.1)"}}),n.jsx("div",{style:{position:"absolute",left:"50%",top:"15%",width:"12%",height:"35%",background:"#576070",borderRadius:"clamp(1px, 0.3vw, 2px)",transform:"translateX(-50%)",border:"1px solid rgba(255,255,255,0.1)",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.2)"}})]})]}),n.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[n.jsx("span",{style:{fontSize:"clamp(12px, 2.8vw, 13px)",color:"#cbd5e1"},children:"Place Block"}),n.jsxs("div",{style:{position:"relative",width:"clamp(50px, 12vw, 60px)",height:"clamp(35px, 8vw, 42px)",background:"#2a3442",borderRadius:"clamp(15px, 4vw, 18px) clamp(15px, 4vw, 18px) clamp(8px, 2vw, 10px) clamp(8px, 2vw, 10px)",border:"1.5px solid rgba(255,255,255,0.2)",boxShadow:"0 3px 12px rgba(0,0,0,0.5), inset 0 1px 3px rgba(255,255,255,0.15)",display:"flex",alignItems:"center",justifyContent:"center",cursor:"default"},children:[n.jsx("div",{style:{position:"absolute",left:"12%",top:"15%",width:"35%",height:"50%",background:"#3d4654",borderRadius:"clamp(6px, 1.5vw, 8px) clamp(6px, 1.5vw, 8px) clamp(2px, 0.5vw, 3px) clamp(2px, 0.5vw, 3px)",border:"1px solid rgba(255,255,255,0.15)",boxShadow:"inset 0 1px 3px rgba(0,0,0,0.3), 0 1px 2px rgba(255,255,255,0.1)"}}),n.jsx("div",{style:{position:"absolute",right:"12%",top:"15%",width:"35%",height:"50%",background:"#2dd4bf",borderRadius:"clamp(6px, 1.5vw, 8px) clamp(6px, 1.5vw, 8px) clamp(2px, 0.5vw, 3px) clamp(2px, 0.5vw, 3px)",border:"2px solid rgba(94,234,212,0.7)",boxShadow:"inset 0 1px 3px rgba(0,0,0,0.24)"}}),n.jsx("div",{style:{position:"absolute",left:"50%",top:"15%",width:"12%",height:"35%",background:"#576070",borderRadius:"clamp(1px, 0.3vw, 2px)",transform:"translateX(-50%)",border:"1px solid rgba(255,255,255,0.1)",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.2)"}})]})]})]})]})]})]}),d&&n.jsxs("div",{role:"alert",style:{marginBottom:"clamp(16px, 4vw, 24px)",padding:"16px 18px",color:"#fee2e2",background:"rgba(69, 10, 10, 0.94)",border:"1px solid rgba(248, 113, 113, 0.45)",borderRadius:12,boxShadow:"0 14px 36px rgba(0,0,0,0.28)",fontFamily:"ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",fontSize:12,lineHeight:1.5},children:[n.jsx("div",{style:{fontWeight:800,fontSize:13,marginBottom:4},children:"MyCraft could not start"}),n.jsxs("div",{style:{overflowWrap:"anywhere"},children:[d.name,": ",d.message]}),n.jsxs("details",{style:{marginTop:8},children:[n.jsx("summary",{style:{cursor:"pointer"},children:"Startup diagnostics"}),n.jsxs("div",{style:{marginTop:6,whiteSpace:"pre-wrap",overflowWrap:"anywhere"},children:["Stage: ",d.stageLabel," (",d.stage,")",`
...
Warmup elapsed: ${Math.round(d.warmup.warmupElapsedMs)} ms`]}),d.stack&&n.jsx("pre",{style:{margin:"8px 0 0",whiteSpace:"pre-wrap",overflowWrap:"anywhere"},children:d.stack})]})]}),n.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(16px, 4vw, 24px)"},children:[n.jsxs("div",{style:{display:"grid",gap:12},children:[n.jsx("div",{style:{fontSize:14,fontWeight:600,color:"#e2e8f0",textTransform:"uppercase",letterSpacing:.5},children:"World Size"}),n.jsx(Ur,{value:A,onChange:y,disabled:x}),n.jsx("div",{style:{fontSize:12,color:"#64748b",fontStyle:"italic",lineHeight:1.4}})]}),n.jsx("button",{onClick:E,disabled:x,"aria-busy":S==="new",style:{padding:"clamp(12px, 3vw, 16px) clamp(20px, 5vw, 24px)",background:"#2dd4bf",color:"#061311",border:"1px solid rgba(94,234,212,0.5)",borderRadius:12,cursor:"pointer",fontWeight:700,fontSize:"clamp(14px, 3.5vw, 16px)",letterSpacing:.5,textTransform:"uppercase",boxShadow:"0 10px 24px rgba(0,0,0,0.32)",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",outline:"none",position:"relative",overflow:"hidden",height:ge,minHeight:ge,boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"center",lineHeight:"20px",whiteSpace:"nowrap"},onMouseOver:c=>{c.currentTarget.style.transform="translateY(-2px)",c.currentTarget.style.boxShadow="0 14px 30px rgba(0,0,0,0.38)",c.currentTarget.style.background="#5eead4"},onMouseOut:c=>{c.currentTarget.style.transform="translateY(0)",c.currentTarget.style.boxShadow="0 10px 24px rgba(0,0,0,0.32)",c.currentTarget.style.background="#2dd4bf"},onMouseDown:c=>{c.currentTarget.style.transform="translateY(0) scale(0.98)"},onMouseUp:c=>{c.currentTarget.style.transform="translateY(-2px) scale(1)"},children:n.jsxs("span",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",gap:10},children:[S==="new"&&n.jsx(nt,{}),S==="new"?`${h?Le[h]:"Preparing new world"}…`:"Launch New World"]})}),n.jsxs("div",{style:{marginTop:"clamp(16px, 4vw, 24px)",padding:"clamp(16px, 4vw, 20px)",background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:12,display:"grid",gap:16,position:"relative"},children:[n.jsx("div",{style:{position:"absolute",top:-8,left:16,background:"#141f2a",padding:"4px 12px",borderRadius:8,fontSize:11,fontWeight:600,color:"#cbd5e1",letterSpacing:.5,border:"1px solid rgba(255,255,255,0.06)"},children:"Alternatively"}),n.jsx("div",{style:{fontSize:12,color:"#64748b",fontStyle:"italic",lineHeight:1.4},children:'You can also load a world saved by yourself or others. Click "Load Saved World", and select the saved JSON file.'}),n.jsx("button",{onClick:b,disabled:x,"aria-busy":S==="load",style:{padding:"clamp(12px, 3vw, 16px) clamp(20px, 5vw, 24px)",background:"#1f2937",color:"#f8fafc",border:"1px solid rgba(148,163,184,0.22)",borderRadius:12,cursor:"pointer",fontWeight:700,fontSize:"clamp(14px, 3.5vw, 16px)",letterSpacing:.5,textTransform:"uppercase",boxShadow:"0 10px 24px rgba(0,0,0,0.28)",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",outline:"none",position:"relative",overflow:"hidden",height:ge,minHeight:ge,boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"center",lineHeight:"20px",whiteSpace:"nowrap"},onMouseOver:c=>{c.currentTarget.style.transform="translateY(-2px)",c.currentTarget.style.boxShadow="0 14px 30px rgba(0,0,0,0.34)",c.currentTarget.style.background="#253244"},onMouseOut:c=>{c.currentTarget.style.transform="translateY(0)",c.currentTarget.style.boxShadow="0 10px 24px rgba(0,0,0,0.28)",c.currentTarget.style.background="#1f2937"},onMouseDown:c=>{c.currentTarget.style.transform="translateY(0) scale(0.98)"},onMouseUp:c=>{c.currentTarget.style.transform="translateY(-2px) scale(1)"},children:n.jsxs("span",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",gap:10},children:[S==="load"&&n.jsx(nt,{}),S==="load"?`${h?Le[h]:"Loading saved world"}…`:"Load Saved World"]})})]})]})]}),n.jsx("style",{children:`
  ...
  `}function da(){return`${le.map((e,t)=>`
    ...
    const float OCEAN_WAVE_AMPLITUDE_${t} = ${(e.amplitude*It).toFixed(6)};
...
`)}
  ...
  `).join(`
`)}const pa=.5,Za=["aboveOpaque","aboveCutout","belowOpaque","belowCutout","boundaryOpaque","boundaryCutout"];function ua(e,t,r,a=pa){if(!Number.isFinite(e)||!Number.isFinite(t)||!Number.isFinite(r)||!Number.isFinite(a)||e>t||a<0)return"boundary";const o=r-a,i=r+a;return e>i?"above":t<o?"below":"boundary"}function qa(e){return e.startsWith("above")?"above":e.startsWith("below")?"below":"boundary"}const Re=1,Ae=1.333,fa=14,ht=Math.tan(Math.asin(Re/Ae)),Ce=new bt(new Uint8Array([255,255,255,255]),1,1,wt,Ut);Ce.colorSpace=vt;Ce.needsUpdate=!0;const _e=new bt(new Float32Array([0,0,0,0]),1,1,wt,Xt);_e.colorSpace=vt;_e.needsUpdate=!0;const D={uForwardRefractionActive:{value:0},uForwardWaterLevel:{value:43.5},uForwardRefractionTime:{value:0},uForwardRefractionWaveAmp:{value:1},uForwardRefractionWaveChop:{value:1},uForwardRefractionWaveSpeed:{value:1},uForwardRefractionResolution:{value:new X(1,1)},uForwardProjectionMatrix:{value:new yt},uForwardCameraUnderwater:{value:!1},uForwardRefractionOutputReceiver:{value:0},uForwardRefractionRenderMode:{value:0},uForwardSunVisibility:{value:Ce},uForwardReceiverWorld:{value:_e}},Xe="mycraftForwardRefraction",ze="mycraftForwardRefractionMrt",xe="mycraftForwardRefractionMedium",be="mycraftForwardRefractionReceiverMaterial",we="mycraftForwardRefractionColorMaterial";function Ya(e,t){e.updateWorldMatrix(!0,!1);const r=new Yt().setFromObject(e);return ua(r.min.y,r.max.y,t,te)}function Ka(e){D.uForwardWaterLevel.value=e.waterLevel,D.uForwardRefractionTime.value=e.time,D.uForwardRefractionWaveAmp.value=e.waveAmp,D.uForwardRefractionWaveChop.value=e.waveChop,D.uForwardRefractionWaveSpeed.value=e.waveSpeed,D.uForwardCameraUnderwater.value=e.cameraUnderwater}function Ja(e,t){D.uForwardRefractionResolution.value.set(Math.max(1,Math.floor(e)),Math.max(1,Math.floor(t)))}function Qa(e){D.uForwardProjectionMatrix.value.copy(e.projectionMatrix)}function en(e){D.uForwardRefractionActive.value=e?1:0}function tn(e){D.uForwardRefractionOutputReceiver.value=e?1:0}function rn(e){D.uForwardRefractionRenderMode.value=e}function an(e){D.uForwardSunVisibility.value=e??Ce}function nn(e){D.uForwardReceiverWorld.value=e??_e}function on(e,t={}){Object.assign(e.uniforms,D),e.userData[Xe]=!0,t.mrt!==!1?e.userData[ze]=!0:delete e.userData[ze]}function Wt(e){return e.userData[Xe]===!0}function sn(e){return e.userData[ze]===!0}const gt=1;function ha(e){if(!(e instanceof Gt)&&!(e instanceof Zt)&&!(e instanceof qt))return null;const t=e.material;if(!t)return null;const r=Array.isArray(t)?t:[t];return r.length>0?r:null}class cn{participants=new Set;previousLayerMasks=new Map;register(t,r={}){const a=t,o=ha(t);return!o||!o.every(i=>Wt(i))?!1:(this.previousLayerMasks.has(a)||this.previousLayerMasks.set(a,a.layers.mask),r.forwardOnly?a.layers.set(gt):a.layers.enable(gt),r.medium?a.userData[xe]=r.medium:delete a.userData[xe],r.receiverMaterial&&r.colorMaterial?(a.userData[be]=r.receiverMaterial,a.userData[we]=r.colorMaterial):(delete a.userData[be],delete a.userData[we]),this.participants.add(a),!0)}registerTree(t){t.traverse(r=>{this.register(r)})}unregister(t){const r=t;this.participants.delete(r),delete r.userData[xe],delete r.userData[be],delete r.userData[we];const a=this.previousLayerMasks.get(r);a!==void 0&&(r.layers.mask=a,this.previousLayerMasks.delete(r))}unregisterTree(t){t.traverse(r=>{this.unregister(r)})}getParticipants(){return this.participants}get size(){return this.participants.size}clear(){for(const t of this.participants){const r=this.previousLayerMasks.get(t);r!==void 0&&(t.layers.mask=r),delete t.userData[xe],delete t.userData[be],delete t.userData[we]}this.participants.clear(),this.previousLayerMasks.clear()}}class ln{frustum=new Kt;projectionView=new yt;sourceCamera=new Jt;cameraWorld=new N;cameraForward=new N;ray=new N;tangent=new N;sourceDirection=new N;up=new N(0,1,0);acceptsAll=!0;waterLevel=0;halfAngle=Math.PI*.5;update(t,r){this.waterLevel=r,t.updateMatrixWorld(),t.getWorldPosition(this.cameraWorld),t.getWorldDirection(this.cameraForward);let a=0,o=0;for(let s=-1;s<=1;s+=1)for(let l=-1;l<=1;l+=1)this.ray.set(l,s,-1).unproject(t).sub(this.cameraWorld).normalize(),this.transportUpwardRay(this.ray)&&(o+=1,a=Math.max(a,Math.acos(Q.clamp(this.cameraForward.dot(this.sourceDirection),-1,1))));const i=Q.degToRad(5);this.halfAngle=a+i,this.acceptsAll=o===0||this.halfAngle>=Q.degToRad(89.5),!this.acceptsAll&&(this.halfAngle=Math.min(this.halfAngle,Q.degToRad(89.25)),this.sourceCamera.fov=Q.radToDeg(this.halfAngle*2),this.sourceCamera.aspect=1,this.sourceCamera.near=Math.max(.01,t.near),this.sourceCamera.far=Math.max(this.sourceCamera.near+1,t.far),this.sourceCamera.updateProjectionMatrix(),this.projectionView.multiplyMatrices(this.sourceCamera.projectionMatrix,t.matrixWorldInverse),this.frustum.setFromProjectionMatrix(this.projectionView))}intersectsBox(t){return this.acceptsAll||t.isEmpty()||!Number.isFinite(t.min.x)||!Number.isFinite(t.min.y)||!Number.isFinite(t.min.z)||!Number.isFinite(t.max.x)||!Number.isFinite(t.max.y)||!Number.isFinite(t.max.z)?!0:t.max.y<=this.waterLevel-te?!1:this.frustum.intersectsBox(t)}getDiagnostics(){return{acceptsAll:this.acceptsAll,halfAngleDegrees:Q.radToDeg(this.halfAngle),waterLevel:this.waterLevel}}transportUpwardRay(t){const r=t.y;if(r<=1e-5)return!1;this.tangent.copy(t).addScaledVector(this.up,-r);const a=this.tangent.length(),o=Ae/Re*a;return o>=1-1e-6?!1:(this.tangent.multiplyScalar(o/Math.max(a,1e-6)),this.sourceDirection.copy(this.tangent),this.sourceDirection.y=Math.sqrt(Math.max(0,1-o*o)),this.sourceDirection.normalize(),!0)}}const ga=le.map((e,t)=>`
  {
    float k = 6.28318530718 / OCEAN_WAVE_LENGTH_${t};
    float depthK = min(k * OCEAN_WATER_DEPTH, 20.0);
    float depthExp = exp(min(2.0 * depthK, 20.0));
...
`);function ma(){return`
    ...
    vec3 forwardRefractionSolveTangentInterface(
      ...
      float cameraReach = cameraPlaneDistance * ${ht.toFixed(9)};
      float sourceReach = sourcePlaneDistance * ${ht.toFixed(9)};
  ...
  `}function dn(e){if(Wt(e))return;const t=e.onBeforeCompile,r=e.customProgramCacheKey.bind(e);e.onBeforeCompile=(a,o)=>{t.call(e,a,o),Object.assign(a.uniforms,D),a.vertexShader=`${ma()}
...
${a.fragmentShader}`.replace("void main() {",`void main() {
  ...
  if (uForwardRefractionOutputReceiver > 0.5) {
    ...
    return;
  }`)},e.customProgramCacheKey=()=>`${r()}|forward-refraction-v1`,e.userData[Xe]=!0,e.needsUpdate=!0}const ba=["overview","player-spawn","player-ridge","player-gully","sky"],jt=Ue.eyeHeight;function wa(e){return e==="localhost"||e==="127.0.0.1"||e==="::1"||e==="[::1]"}function va(e){return e!=null&&ba.includes(e)}function ya(e){if(!wa(e.hostname))return null;const t=new URLSearchParams(e.search);if(t.get("debug")!=="1")return null;const r=t.get("view");if(!va(r))return null;const a=t.get("time");if(!a)return{view:r};const i={sunrise:.02,noon:.25,sunset:.48,midnight:.75}[a.toLowerCase()]??Number.parseFloat(a);return Number.isFinite(i)?{view:r,time:(i%1+1)%1}:null}function Sa(e,t,r,a){let o={x:t,z:r,height:Z(t,r,e,a)};if(o.height>J+1)return o;for(let i=1;i<=8;i+=1){for(let s=-i;s<=i;s+=1)for(let l=-i;l<=i;l+=1){if(Math.abs(s)!==i&&Math.abs(l)!==i)continue;const p=t+s,h=r+l,d=Z(p,h,e,a);d>o.height&&(o={x:p,z:h,height:d})}if(o.height>J+1)return o}return o}function Dt(e,t){const r=t.x-e.x,a=t.y-e.y,o=t.z-e.z,i=Math.max(1e-6,Math.hypot(r,o));return{yaw:Math.atan2(-r,-o),pitch:Math.atan2(a,i)}}function mt(e,t,r,a){const s=Z(t,r,e,a),l=[new X(0,-1),new X(1,0),new X(0,1),new X(-1,0),new X(1,-1).normalize(),new X(1,1).normalize(),new X(-1,1).normalize(),new X(-1,-1).normalize()];let p=l[0],h=Number.POSITIVE_INFINITY;for(const d of l){const x=t+d.x*16,w=r+d.y*16,A=Z(x,w,e,a),y=s-A,m=A<=J+2?1e3:0,u=Math.max(0,-y)*2,g=Math.abs(y-4)+u+m;g<h&&(h=g,p=d)}return new N(p.x*16,-2.5,p.y*16)}function Ne(e,t,r,a,o){const i=Sa(e,r,a,t),s=new N(i.x,i.height+1+jt,i.z),l=i.x+o.x,p=i.z+o.z,h=Z(l,p,e,t),d=new N(l,h+1+o.y,p),x=Dt(s,d);return{position:s,...x}}function Ea(e,t){const r=aa(t.seed,0,0,t.worldRadius);switch(e){case"overview":{const a=new N(r.x,Z(r.x,r.z,t.seed,t.worldRadius)+1,r.z),o=a.clone().add(new N(12,Ue.height*3,12));return{position:o,...Dt(o,a)}}case"player-spawn":return Ne(t.seed,t.worldRadius,r.x,r.z,mt(t.seed,r.x,r.z,t.worldRadius));case"player-ridge":return Ne(t.seed,t.worldRadius,20,-18,mt(t.seed,20,-18,t.worldRadius));case"player-gully":return Ne(t.seed,t.worldRadius,-22,18,new N(4,-1.5,-6));case"sky":return{position:new N(r.x,Z(r.x,r.z,t.seed,t.worldRadius)+jt+1,r.z),yaw:0,pitch:Q.degToRad(65)}}}function pn(e,t,r){const a=Ea(t,r);e.rotation.order="YXZ",e.position.copy(a.position),e.rotation.set(a.pitch,a.yaw,0),e.updateMatrixWorld(!0)}function Ra(){const e=ya(window.location);return e?n.jsx(Zr,{view:e.view,time:e.time}):n.jsxs(n.Fragment,{children:[n.jsx(Ct,{}),n.jsx(Xr,{}),n.jsx(Cr,{}),n.jsx(_r,{}),n.jsx(kr,{}),n.jsx(Tr,{}),n.jsx(Fr,{}),n.jsx(Pr,{}),n.jsx(Ir,{}),n.jsx(Gr,{})]})}Bt.createRoot(document.getElementById("root")).render(n.jsx(C.StrictMode,{children:n.jsx(Ra,{})}));export{dn as $,Re as A,da as B,ee as C,le as D,na as E,gt as F,oa as G,la as H,Ga as I,ta as J,Ba as K,Ua as L,Ka as M,Xa as N,za as O,Ya as P,Ue as Q,Wr as R,J as S,Ma as T,Na as U,Fa as V,$a as W,Ia as X,Wa as Y,Ve as Z,Rt as _,Za as a,an as a0,pr as a1,f as a2,Ta as a3,aa as a4,pn as a5,He as a6,Et as a7,Oe as a8,Ee as a9,ja as aa,Da as ab,Pa as ac,Nr as ad,Mr as ae,Lr as af,Va as b,Ha as c,on as d,xa as e,ma as f,qa as g,Oa as h,La as i,Me as j,Pe as k,te as l,Ae as m,ln as n,cn as o,D as p,Ja as q,Qa as r,nn as s,en as t,rn as u,tn as v,we as w,sn as x,xe as y,be as z};
